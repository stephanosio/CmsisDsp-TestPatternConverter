        ...
        public override IEnumerable<TestModel> TestModels { get; protected set; } = new List<TestModel>
        {
            ...
            new TestModel
            {
                ...
                Patterns = new List<PatternModel>
                {
                    ...
                    new PatternModel("q7_t", "in_absminmax", "InputNew1_q7.txt"),
                    new PatternModel("q7_t", "in_max_maxidx", "InputMaxIndexMax1_q7.txt"),
                    new PatternModel("q7_t", "in_min_maxidx", "InputMinIndexMax3_q7.txt"),
                    new PatternModel("q7_t", "in_absmax_maxidx", "InputAbsMaxIndexMax8_q7.txt"),
                    new PatternModel("q7_t", "in_absmin_maxidx", "InputAbsMinIndexMax9_q7.txt"),
                    new PatternModel("q7_t", "ref_max_val", "MaxVals1_q7.txt"),
                    new PatternModel("uint16_t", "ref_max_idx", "MaxIndexes1_s16.txt"),
                    new PatternModel("q7_t", "ref_min_val", "MinVals3_q7.txt"),
                    new PatternModel("uint16_t", "ref_min_idx", "MinIndexes3_s16.txt"),
                    new PatternModel("q7_t", "ref_absmax_val", "AbsMaxVals8_q7.txt"),
                    new PatternModel("uint16_t", "ref_absmax_idx", "AbsMaxIndexes8_s16.txt"),
                    new PatternModel("q7_t", "ref_absmin_val", "AbsMinVals9_q7.txt"),
                    new PatternModel("uint16_t", "ref_absmin_idx", "AbsMinIndexes9_s16.txt"),
            ...
            new TestModel
            {
                ...
                Patterns = new List<PatternModel>
                {
                    ...
                    new PatternModel("q15_t", "in_absminmax", "InputNew1_q15.txt"),
                    new PatternModel("q15_t", "ref_max_val", "MaxVals1_q15.txt"),
                    new PatternModel("uint16_t", "ref_max_idx", "MaxIndexes1_s16.txt"),
                    new PatternModel("q15_t", "ref_min_val", "MinVals3_q15.txt"),
                    new PatternModel("uint16_t", "ref_min_idx", "MinIndexes3_s16.txt"),
                    new PatternModel("q15_t", "ref_absmax_val", "AbsMaxVals8_q15.txt"),
                    new PatternModel("uint16_t", "ref_absmax_idx", "AbsMaxIndexes8_s16.txt"),
                    new PatternModel("q15_t", "ref_absmin_val", "AbsMinVals9_q15.txt"),
                    new PatternModel("uint16_t", "ref_absmin_idx", "AbsMinIndexes9_s16.txt"),
            ...
            new TestModel
            {
                ...
                Patterns = new List<PatternModel>
                {
                    ...
                    new PatternModel("q31_t", "in_absminmax", "InputNew1_q31.txt"),
                    new PatternModel("q31_t", "ref_max_val", "MaxVals1_q31.txt"),
                    new PatternModel("uint16_t", "ref_max_idx", "MaxIndexes1_s16.txt"),
                    new PatternModel("q31_t", "ref_min_val", "MinVals3_q31.txt"),
                    new PatternModel("uint16_t", "ref_min_idx", "MinIndexes3_s16.txt"),
                    new PatternModel("q31_t", "ref_absmax_val", "AbsMaxVals8_q31.txt"),
                    new PatternModel("uint16_t", "ref_absmax_idx", "AbsMaxIndexes8_s16.txt"),
                    new PatternModel("q31_t", "ref_absmin_val", "AbsMinVals9_q31.txt"),
                    new PatternModel("uint16_t", "ref_absmin_idx", "AbsMinIndexes9_s16.txt"),
            ...
            new TestModel
            {
                TestCodePath = "statistics/src/f16.c",
                PatternRootPath = "Stats/StatsF16",
                Patterns = new List<PatternModel>
                {
                    new PatternModel("uint16_t", "in_com1", "Input1_f16.txt"),
                    new PatternModel("uint16_t", "in_com2", "Input2_f16.txt"),
                    new PatternModel("uint16_t", "in_absminmax", "InputNew1_f16.txt"),
                    new PatternModel("uint16_t", "in_entropy", "Input22_f16.txt"),
                    new PatternModel("uint16_t", "in_entropy_dim", "Dims22_s16.txt"),
                    new PatternModel("uint16_t", "in_logsumexp", "Input23_f16.txt"),
                    new PatternModel("uint16_t", "in_logsumexp_dim", "Dims23_s16.txt"),
                    new PatternModel("uint16_t", "in_kl1", "InputA24_f16.txt"),
                    new PatternModel("uint16_t", "in_kl2", "InputB24_f16.txt"),
                    new PatternModel("uint16_t", "in_kl_dim", "Dims24_s16.txt"),
                    new PatternModel("uint16_t", "in_logsumexp_dp1", "InputA25_f16.txt"),
                    new PatternModel("uint16_t", "in_logsumexp_dp2", "InputB25_f16.txt"),
                    new PatternModel("uint16_t", "in_logsumexp_dp_dim", "Dims25_s16.txt"),
                    new PatternModel("uint16_t", "ref_max_val", "MaxVals1_f16.txt"),
                    new PatternModel("uint16_t", "ref_max_idx", "MaxIndexes1_s16.txt"),
                    new PatternModel("uint16_t", "ref_min_val", "MinVals3_f16.txt"),
                    new PatternModel("uint16_t", "ref_min_idx", "MinIndexes3_s16.txt"),
                    new PatternModel("uint16_t", "ref_absmax_val", "AbsMaxVals26_f16.txt"),
                    new PatternModel("uint16_t", "ref_absmax_idx", "AbsMaxIndexes26_s16.txt"),
                    new PatternModel("uint16_t", "ref_absmin_val", "AbsMinVals27_f16.txt"),
                    new PatternModel("uint16_t", "ref_absmin_idx", "AbsMinIndexes27_s16.txt"),
                    new PatternModel("uint16_t", "ref_mean", "MeanVals2_f16.txt"),
                    new PatternModel("uint16_t", "ref_power", "PowerVals4_f16.txt"),
                    new PatternModel("uint16_t", "ref_rms", "RmsVals5_f16.txt"),
                    new PatternModel("uint16_t", "ref_std", "StdVals6_f16.txt"),
                    new PatternModel("uint16_t", "ref_var", "VarVals7_f16.txt"),
                    new PatternModel("uint16_t", "ref_entropy", "RefEntropy22_f16.txt"),
                    new PatternModel("uint16_t", "ref_logsumexp", "RefLogSumExp23_f16.txt"),
                    new PatternModel("uint16_t", "ref_kl", "RefKL24_f16.txt"),
                    new PatternModel("uint16_t", "ref_logsumexp_dp", "RefLogSumExpDot25_f16.txt")
                }
            },
            ...
            new TestModel
            {
                ...
                Patterns = new List<PatternModel>
                {
                    ...
                    new PatternModel("uint32_t", "in_absminmax", "InputNew1_f32.txt"),
                    ...
                    new PatternModel("uint16_t", "ref_min_idx", "MinIndexes3_s16.txt"),
                    new PatternModel("uint32_t", "ref_absmax_val", "AbsMaxVals26_f32.txt"),
                    new PatternModel("uint16_t", "ref_absmax_idx", "AbsMaxIndexes26_s16.txt"),
                    new PatternModel("uint32_t", "ref_absmin_val", "AbsMinVals27_f32.txt"),
                    new PatternModel("uint16_t", "ref_absmin_idx", "AbsMinIndexes27_s16.txt"),
