        ...
        public override IEnumerable<TestModel> Tests { get; } = new List<TestModel>
        {
            ...
            new TestModel
            {
                ...
                Patterns = new List<PatternModel>
                {
                    ...
                    new PatternModel("int16_t", "in_dims", "DimsUnary1_s16.txt"),
            ...
            new TestModel
            {
                ...
                Patterns = new List<PatternModel>
                {
                    ...
                    new PatternModel("int16_t", "in_dims", "DimsUnary1_s16.txt"),
                    new PatternModel("int16_t", "in_inv_dims", "DimsInvert1_s16.txt"),
            ...
            new TestModel
            {
                ...
                Patterns = new List<PatternModel>
                {
                    ...
                    new PatternModel("int16_t", "in_dims", "DimsBinary1_s16.txt"),
